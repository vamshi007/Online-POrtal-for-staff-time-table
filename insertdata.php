<?php
	...
	{
		 $sql = "CREATE TABLE VAR".$tablename." (
				monday VARCHAR(20) null ,
				tuesday VARCHAR(20) null,
				wednesday VARCHAR(20) null,
				thursday VARCHAR(20) null,
				friday VARCHAR(20) null,
				saturday VARCHAR(20) null
				)";
		$sqll = "TRUNCATE TABLE  VAR".$tablename;
